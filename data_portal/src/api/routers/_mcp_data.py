"""
MCP (Model Context Protocol) — data constants & tool handler functions.
Imported by mcp.py.
"""
import logging
...
MCP_TOOLS: Dict[str, Any] = {
    "search_catalog": {
        "name": "search_catalog",
        "description": "데이터 카탈로그에서 테이블과 컴럼을 벡터 검색합니다 (RAG)",
        "category": "data",
        "parameters": {
            "type": "object",
            "properties": {
...
# ── OMOP CDM 테이블-컴럼 메타데이터 ──────────────────────

OMOP_TABLE_META: Dict[str, Any] = {
    "person": {
        "business_name": "환자",
        "columns": [
