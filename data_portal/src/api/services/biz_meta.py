...
ICD_CODE_MAP: Dict[str, Tuple[str, str]] = {
    ...
    "제1형 당뇨병": ("46635009", "제1형 당뇨병"),
    "고혈압": ("38341003", "고혈압성 장애"),
    "혈압": ("38341003", "고혈압성 장애"),
    "고지혈증": ("55822004", "고지혈증"),
    "고콜레스테롤혈증": ("13644009", "고콜레스테롤혈증"),
    "비만": ("162864005", "비만 (BMI 30+)"),
    "대사증후군": ("237602007", "대사증후군"),
    "갑상선기능저하증": ("40930008", "갑상선기능저하증"),
    "갑상선기능항진증": ("34486009", "갑상선기능항진증"),
    "통풍": ("90560007", "통풍"),
    ...
    "심근경색": ("22298006", "심근경색"),
    "뇌졸중": ("230690007", "뇌졸중"),
    "심부전": ("84114007", "울혈성 심부전"),
    "협심증": ("194828000", "협심증"),
    "부정맥": ("698247007", "심부정맥"),
    "심장판막질환": ("368009", "심장판막 장애"),
    "대동맥류": ("233985008", "대동맥류"),
    "말초혈관질환": ("400047006", "말초혈관질환"),
    "폐색전증": ("59282003", "폐색전증"),
    "심정지": ("410429000", "심정지"),
    "동맥경화증": ("441574008", "동맥경화증"),
    "심내막염": ("56819008", "심내막염"),
    "심근병증": ("85898001", "심근병증"),
    ...
    "천식": ("195967001", "천식"),
    "COPD": ("185086009", "만성 폐쇄성 폐질환"),
    "만성폐쇄성폐질환": ("185086009", "만성 폐쇄성 폐질환"),
    "폐렴": ("233604007", "폐렴"),
    "폐암": ("254637007", "폐암"),
    "폐섬유증": ("700250006", "폐섬유증"),
    "수면무호흡": ("78275009", "폐쇄성 수면무호흡"),
    "기흉": ("36118008", "기흉"),

    # ── 신장/비뇨기 질환 ──
    "만성신장질환": ("431855005", "만성 신장질환"),
    "신부전": ("46177005", "신부전"),
    "요로감염": ("301011002", "요로감염"),
    "신결석": ("95570007", "신결석"),
    ...
    # ── 근골격계 질환 ──
    "골관절염": ("239873007", "골관절염"),
    "류마티스관절염": ("69896004", "류마티스 관절염"),
    "골다공증": ("64859006", "골다공증"),
    "요통": ("279039007", "요통"),

    # ── 신경계 질환 ──
    "치매": ("52448006", "치매"),
    "알츠하이머": ("26929004", "알츠하이머병"),
    "파킨슨": ("49049000", "파킨슨병"),
    "뇌전증": ("84757009", "뇌전증(간질)"),
    "간질": ("84757009", "뇌전증(간질)"),
    "편두통": ("37796009", "편두통"),
    ...
    # ── 정신건강 ──
    "우울증": ("36923009", "주요 우울장애"),
    "불안장애": ("197480006", "불안장애"),

    # ── 소화기 질환 ──
    "위식도역류": ("235595009", "위식도역류질환(GERD)"),
    "크론병": ("34000006", "크론병"),
    "궤양성대장염": ("64766004", "궤양성 대장염"),
    "대장암": ("363406005", "대장암"),
    ...
    # ── 피부 질환 ──
    "아토피피부염": ("24079001", "아토피 피부염"),
    "건선": ("9014002", "건선"),

    # ── 기타 ──
    "알레르기비염": ("444814009", "알레르기 비염"),
    "만성부비동염": ("40055000", "만성 부비동염"),
}
