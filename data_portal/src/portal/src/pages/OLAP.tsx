...
const mockQueryResult = {
  ...
  data: [
    { key: '1', gender: 'F', age_band: 20, avg_stay_days: 5.2, patient_count: 120 },
    { key: '2', gender: 'M', age_band: 20, avg_stay_days: 6.1, patient_count: 110 },
    { key: '3', gender: 'F', age_band: 30, avg_stay_days: 7.8, patient_count: 230 },
    { key: '4', gender: 'M', age_band: 30, avg_stay_days: 8.5, patient_count: 250 },
    { key: '5', gender: 'F', age_band: 40, avg_stay_days: 9.1, patient_count: 310 },
    { key: '6', gender: 'M', age_band: 40, avg_stay_days: 10.2, patient_count: 300 },
    { key: '7', gender: 'F', age_band: 50, avg_stay_days: 11.5, patient_count: 450 },
    { key: '8', gender: 'M', age_band: 50, avg_stay_days: 12.3, patient_count: 480 },
  ],
};
    ...
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      <Card>
        ...
        <Paragraph type="secondary">
          데이터 레이크하우스에 직접 SQL 쿼리를 실행하여 OLAP 분석을 수행합니다.
        </Paragraph>
        <Alert
