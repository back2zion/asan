  ...
  return (
    <div style={{ padding: '0' }}>
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          <Row align="middle" justify="space-between">
            <Col>
              ...
              <Paragraph type="secondary" style={{ 
                ...
                SFR-006: 컨테이너 기반의 AI 데이터 분석환경 플랫폼
              </Paragraph>
            </Col>
            <Col>
        ...
        {/* SFR-006 요구사항 준수 현황 */}
        <Card title="SFR-006 요구사항 준수 현황">
          <Row gutter={[16, 16]}>
            <Col xs={24} lg={8}>
              <Card type="inner" title="사용자 분석 환경" size="small">
                <Space direction="vertical">
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> JupyterLab 웹 기반 환경</div>
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> GPU 연산 처리 지원</div>
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> 다양한 분석 언어 지원</div>
                </Space>
              </Card>
            </Col>
            <Col xs={24} lg={8}>
              <Card type="inner" title="리소스 관리" size="small">
                <Space direction="vertical">
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> 프로젝트별 리소스 할당</div>
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> 실시간 사용량 모니터링</div>
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> 자동 스케일링 지원</div>
                </Space>
              </Card>
            </Col>
            <Col xs={24} lg={8}>
              <Card type="inner" title="생성형 AI 분석" size="small">
                <Space direction="vertical">
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> SOTA LLM 통합</div>
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> GraphRAG 검색 증강</div>
                  <div><ThunderboltOutlined style={{ color: '#52A67D' }} /> LangGraph 에이전트 시스템</div>
                </Space>
              </Card>
            </Col>
          </Row>
          ...
          <Alert
            message="SFR-006 완전 준수"
            description="컨테이너 기반의 AI 데이터 분석환경이 구축되어 사용자별 독립적인 분석 환경과 최신 생성형 AI 기술을 제공합니다."
            type="success"
            showIcon
            style={{ marginTop: 16 }}
          />
