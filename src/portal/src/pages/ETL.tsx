...
const mockPipelines = [
  {
    ...
    status: 'success',
    last_run: moment().subtract(1, 'day').add(1, 'hour').toISOString(),
    next_run: moment().add(1, 'hour').toISOString(),
  ...
  },
  {
    ...
    status: 'running',
    last_run: moment().subtract(3, 'minutes').toISOString(),
    next_run: moment().add(1, 'day').add(3, 'hour').toISOString(),
  ...
  },
  {
    ...
    status: 'failed',
    last_run: moment().subtract(6, 'day').toISOString(),
    next_run: moment().add(1, 'day').add(6, 'hour').toISOString(),
  ...
  },
  {
    ...
    status: 'success',
    last_run: moment().subtract(30, 'seconds').toISOString(),
...
const ETL: React.FC = () => {
  ...
  const pipelineColumns = [
    ...
    },
    {
      ...
      dataIndex: 'last_run',
      key: 'last_run',
      render: (isoString: string) => moment(isoString).fromNow(),
    },
    {
      title: '소유자',
      dataIndex: 'owner',
        ...
        <Row align="middle" justify="space-between">
          <Col>
            ...
            <Paragraph type="secondary">
              SFR-003: Apache Airflow 기반으로 운영되는 데이터 파이프라인의 현황을 모니터링하고 관리합니다.
            </Paragraph>
          </Col>
          <Col>
            <Button 
